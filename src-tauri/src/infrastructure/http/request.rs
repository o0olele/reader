...
pub use headers::evaluate_sign_script;
use headers::{add_custom_header, resolve_source_headers};
use user_agent::client_hints;
#[cfg(test)]
use user_agent::resolve_user_agent;
pub use user_agent::{
    set_detected_user_agent, set_user_agent, user_agent, user_agent_override, DEFAULT_USER_AGENT,
};
